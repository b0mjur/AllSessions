...
//       saveYaml(studentList);
    ...
    public static void saveYaml (List<Student> students) {
        ...
        try {
            mapper.writeValue(new File("C:\\Users\\vital\\FullStackPortnov\\Java\\MyCode\\students.yaml"), students);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
//
    public static List<Student> loadFromYaml() {
        ...
        try {
            result = mapper.readValue(new File("C:\\Users\\vital\\FullStackPortnov\\Java\\MyCode\\students.yaml"), mapper.getTypeFactory().constructCollectionType(List.class, Student.class));
